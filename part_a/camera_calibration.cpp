...
int main(int argc, char* argv[])
{
    ...
    cout << "opened the configuration file: \"" << inputSettingsFile << "\"" << endl;
    fs["Settings"] >> s;
    ...
    cout << "Board size is: " << s.boardSize.width << "x" << s.boardSize.height << endl;
    if (!s.goodInput)
    {
    ...
    for(;;)
    {
        ...
        case Settings::CHESSBOARD:
            ...
            cout << "searching for chessboard corners: " << found << endl;
            break;
        ...
        if ( found)                // If done with success,
        {
              // improve the found corners' coordinate accuracy for chessboard
                ...
                {
                    cout << "improving corners' coordinate accuracy" << endl;
                    Mat viewGray;
